...
const TAG_STYLES: Record<string, string> = {
  ...
  'Docs':      'bg-violet-500/10 text-violet-600 dark:text-violet-400',
  'Community': 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400',
  'Social':    'bg-cyan-500/10 text-cyan-600 dark:text-cyan-400',
  'Discord':   'bg-indigo-500/10 text-indigo-600 dark:text-indigo-400',
  'Faucet':    'bg-amber-500/10 text-amber-600 dark:text-amber-400',
};
    ...
    >
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          <span className="text-surface-950 font-medium text-sm group-hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
            {link.name}
          </span>
          {link.tag && (
      ...
      <ExternalLink className="w-3.5 h-3.5 text-surface-500 group-hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex-shrink-0 mt-0.5" />
    </a>
  );
}
      ...
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="flex items-center gap-2 mb-4">
          <div className="w-4 h-4 rounded-full bg-emerald-500/20 flex items-center justify-center">
            <span className="text-emerald-600 dark:text-emerald-400 text-[8px] font-bold">C</span>
          </div>

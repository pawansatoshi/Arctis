...
const OS_PILLARS = [
  {
    ...
    color: 'text-violet-600 dark:text-violet-400', bg: 'bg-violet-500/10', border: 'border-violet-500/20',
  },
  {
    icon: ArrowLeftRight,
    label: 'Stablecoin OS',
  ...
  },
  {
    ...
    color: 'text-emerald-600 dark:text-emerald-400', bg: 'bg-emerald-500/10', border: 'border-emerald-500/20',
  },
  {
    icon: Sparkles,
    label: 'Knowledge OS',
  ...
  return (
    <div className="min-h-screen bg-surface-50 overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none" aria-hidden>
        ...
        <div className="absolute inset-0 opacity-[0.02] dark:hidden"
          style={{ backgroundImage: 'linear-gradient(rgba(15,23,42,0.2) 1px, transparent 1px), linear-gradient(90deg, rgba(15,23,42,0.2) 1px, transparent 1px)', backgroundSize: '72px 72px' }} />
        <div className="hidden dark:block absolute inset-0 opacity-[0.015]"
      ...
      <section className="relative z-10 pt-20 pb-20 px-6 text-center max-w-5xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-600 dark:text-blue-400 text-xs font-medium mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/transfer" className="btn-ghost px-7 py-3.5 text-base border border-black/[0.08] dark:border-white/[0.08]">
              Send USDC
            </Link>
          </div>
        </motion.div>
      ...
      {/* Proof of trust */}
      <section id="proof" className="relative z-10 py-16 border-y border-black/[0.05] dark:border-white/[0.05]">
      ...
      <section className="relative z-10 py-24 px-6 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/agents" className="btn-ghost px-7 py-3.5 text-base border border-black/[0.08] dark:border-white/[0.08]">
              Explore Agents
            </Link>
          </div>
        </motion.div>
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-black/[0.05] dark:border-white/[0.05] py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4 text-surface-600 text-sm">
          <div className="flex items-center gap-2.5">
            <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-blue-500/30 to-violet-500/20 border border-black/[0.1] dark:border-white/[0.1] flex items-center justify-center">
              <span className="text-blue-600 dark:text-blue-400 font-black text-[10px]">A</span>
            </div>

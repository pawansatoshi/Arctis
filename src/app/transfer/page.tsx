                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <a
                      ...
                      className="p-1.5 text-surface-600 hover:text-blue-400 transition-colors"
                    >
                ...
                <div className="mb-4 p-4 rounded-xl bg-amber-500/10 border border-amber-500/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="text-amber-400 font-medium text-sm mb-1">Wrong Network</div>
              ...
              {isConnected && (
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-3 top-1/2 -translate-y-1/2 text-blue-400 text-xs font-medium hover:text-blue-300 transition-colors"
                      >
                        MAX
                      </button>
                    </div>
                  ...
                  {addressValid && amountValid && (
                    <div className="p-3 rounded-xl bg-surface-200/30 border border-white/[0.04] space-y-2 text-xs">
                  ...
                  >
                    {isPending && <><span className="w-4 h-4 border-2 border-white/40 border-t-white rounded-full animate-spin" />Confirm in wallet…</>}
                    {isConfirming && <><span className="w-4 h-4 border-2 border-white/40 border-t-white rounded-full animate-spin" />Confirming on Arc…</>}

...
const INTRO_COPY: Record<LockedAction, { prompt: string; examples: string[] }> = {
  ...
  bridge: { prompt: 'Tell me the USDC amount and source → destination route.', examples: ['Bridge 2 USDC from Arc Testnet to Base Sepolia', 'Bridge 5 USDC from Base Sepolia to Arc Testnet', 'Bridge 1 USDC from Arc Testnet to Arbitrum Sepolia'] },
};
